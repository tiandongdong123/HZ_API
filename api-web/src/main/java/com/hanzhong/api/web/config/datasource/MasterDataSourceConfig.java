package com.hanzhong.api.web.config.datasource;
...
public class MasterDataSourceConfig {
    ...
    protected static final String BASE_PACKAGES = "com.hanzhong.api.web.dao.master";
    private static final String LOCATION_PATTERN = "classpath*:com/hanzhong/api/web/mapping/master/*Mapper.xml";
