package com.hanzhong.api.web.util.gaodemap.geocode;

import com.alibaba.fastjson.JSON;
import com.hanzhong.api.web.util.HttpUtils;
import com.hanzhong.api.web.util.PropertiesUtils;
import com.hanzhong.api.web.util.gaodemap.constant.CmnEnum;
import com.hanzhong.api.web.util.gaodemap.geocode.model.GcQryParam;
...
public class GeoCodeUtils {
    ...
    public static boolean isSuccess(GcQryResult gcQryResult) {
        return gcQryResult != null && CmnEnum.RequestStatusEnum.SUCCESS.getValue().equals(gcQryResult.getStatus());
    }
