...
# 启动类
START_CLASS="com.hanzhong.api.web.WebApplication"
...
if [ -n "${BITS}" ]; then
        JAVA_MEM_OPTS=" -server -Xms4g -Xmx4g -Xmn256m -Xss256k -XX:+HeapDumpOnOutOfMemoryError -XX:+DisableExplicitGC -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled -XX:LargePageSizeInBytes=128m -XX:+UseFastAccessorMethods -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=70 "
    else
