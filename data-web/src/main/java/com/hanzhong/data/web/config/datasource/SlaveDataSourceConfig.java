...
public class SlaveDataSourceConfig {
    ...
    protected static final String BASE_PACKAGES = "com.hanzhong.data.web.dao.slave";
    private static final String LOCATION_PATTERN = "classpath*:com/hanzhong/data/web/mapping/slave/*Mapper.xml";
