package com.hanzhong.data.web.config.datasource;
...
public class MasterDataSourceConfig {
    ...
    protected static final String BASE_PACKAGES = "com.hanzhong.data.web.dao.master";
    private static final String LOCATION_PATTERN = "classpath*:com/hanzhong/data/web/mapping/master/*Mapper.xml";
